...
const useAsyncServiceStatus = (operationName, moduleName = ASYNC_SERVICE_DEFAULT_MODULE_NAME, providerName = ASYNC_SERVICE_DEFAULT_PROVIDER_NAME) => {
...
export default useAsyncServiceStatus
